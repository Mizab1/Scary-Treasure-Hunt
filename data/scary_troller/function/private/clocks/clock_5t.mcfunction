...
execute as @e[type=endermite, tag=creeper_trap_spawner_marker] at @s run function scary_troller:private/clocks/zzz/18
# Setup the guardian trap
execute as @e[type=endermite, tag=guardian_trap_spawner_marker] at @s run function scary_troller:private/clocks/zzz/19
# Setup the hole block
execute as @e[type=endermite, tag=hole_block_spawner_marker] at @s run function scary_troller:private/clocks/zzz/20
# Setup the landmine
execute as @e[type=endermite, tag=landmine_spawner_marker] at @s run function scary_troller:private/clocks/zzz/21
# Setup the fire stone
execute as @e[type=endermite, tag=fire_stone_spawner_marker] at @s run function scary_troller:private/clocks/zzz/22
